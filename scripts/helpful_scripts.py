...
def get_account(index=None, id=None):
    ...
    if (
        ...
        return accounts.add(config["wallets"]["from _key"])
...
def get_contract(contract_name):
    """
    This function will grab the contract address from brownie config if defined ,
    otherwise it will deploy mock contracts and will return the mock contracts.
